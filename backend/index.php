...
<h1>Test insert track SERVER</h1>
<form name="eingabe" action="https://ieslamp.technikum-wien.at/bvu19sys5/jamlocal/savetrack.php" method="POST"></p>
<p>Track Json: <input type="text" name="json"></p>
<input type="submit" name="send" value="Send">
</form>

<h1>Test insert track LOCALHOST</h1>
<form name="eingabe" action="http://localhost/jamlocal/savetrack.php" method="POST"></p>
<p>Track Json: <input type="text" name="json"></p>
<input type="submit" name="send" value="Send">
</form>
